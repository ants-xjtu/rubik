...
stack["tcp"].proto.events.event_map["on_est"] = Event(
    EqualExpr(stack["tcp"].proto.core.trans, ConstRaw(Value([], "5"))),
    [Call("tcp_on_est", {})],
)
...
stack["tcp"].proto.events.before_map["exam"] = {"on_est", "assemble"}
