In this article I will go through the main concepts and features of Rubik. Some of them are overlapped to the content of paper, but in a programmer's perspective rather than designer.
